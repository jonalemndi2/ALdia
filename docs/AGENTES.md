...
las 60 herramientas sin que ninguna tenga que saber que esto existe.
...
herramientas (hoy 60) saturan al modelo; pero una mega-herramienta con un `enum` de 20
...
reescribiendo esas dos, no rediseñando las 60.
